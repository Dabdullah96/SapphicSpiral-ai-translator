(function () {
  ...
  function resolveDefaultLanguage(candidate, fallback) {
    return SUPPORTED_LANGUAGES.includes(candidate) ? candidate : fallback;
  }
  ...
  function mount(config) {
    ...
    const resolvedSourceLang = resolveDefaultLanguage(defaultSourceLang, "English");
    const resolvedTargetLang = resolveDefaultLanguage(defaultTargetLang, "Spanish");
      ...
      <div class="ai-translator">
        ...
        <div class="ai-translator__row">
          <select id="ai-source-lang">
            ${buildLanguageOptions(resolvedSourceLang)}
          </select>
          <select id="ai-target-lang">
            ${buildLanguageOptions(resolvedTargetLang)}
          </select>
        </div>
